...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form method="POST" action="{{ route('proteinas') }}">
                @csrf
                <div class="card">
                    <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <input type="number" class="form-control" name="ruim_a" step="0.01"
                            value="{{$proteinas->ruim_a}}" autocomplete="off" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        value="{{$proteinas->ruim_b}}" autocomplete="off" required>
                    </div>  
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        ...
                        value="{{$proteinas->regular_a}}" autocomplete="off" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        value="{{$proteinas->regular_c}}" autocomplete="off" required>
                    </div>  
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        ...
                        value="{{$proteinas->bom_a}}" autocomplete="off" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        value="{{$proteinas->bom_c}}" autocomplete="off" required>
                    </div>  
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        ...
                        value="{{$proteinas->excelente_a}}" autocomplete="off" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        value="{{$proteinas->excelente_b}}" autocomplete="off" required>
                    </div>  
                </div>
