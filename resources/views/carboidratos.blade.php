...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="form-group row">
                <div class="col-md-6 offset-md-3">
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        <strong>Atenção!</strong> Valores em QUILOS.
            ...
            <form method="POST" action="{{ route('carboidratos') }}">
                @csrf
                <div class="card">
                    <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <input type="number" class="form-control" name="ruim_a" step="0.01"
                            value="{{$carboidratos->ruim_a}}" autocomplete="off" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        value="{{$carboidratos->ruim_b}}" autocomplete="off" required>
                    </div>  
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        ...
                        value="{{$carboidratos->regular_a}}" autocomplete="off" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        value="{{$carboidratos->regular_c}}" autocomplete="off" required>
                    </div>  
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        ...
                        value="{{$carboidratos->bom_a}}" autocomplete="off" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        value="{{$carboidratos->bom_c}}" autocomplete="off" required>
                    </div>  
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        ...
                        value="{{$carboidratos->excelente_a}}" autocomplete="off" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        value="{{$carboidratos->excelente_b}}" autocomplete="off" required>
                    </div>  
                </div>
