...
<div class="row">
    <div class="col-md-12 text-center"> 
        <h3>Visualização ({{ $regra->id }})</h3><br/>
    </div>
</div>
                ...
                <div class="card-header">Antecedentes <strong>(SE)</strong></div>
                        ...
                        <div class="col-md-12 offset-md-3">
                            <div class="form-check-inline">
                                <label><input type="radio" name="tipo_conexao" value="1" 
                                    @if ($regra->tipo_conexao==1) checked @endif disabled>E</label>
                            </div>
                            <div class="form-check-inline">
                                <label><input type="radio" name="tipo_conexao" value="2"
                                    @if ($regra->tipo_conexao==2) checked @endif disabled>OU</label>
                            </div>                                
                        </div>   
                    </div> 
                    <!-- Agua -->
                    <div class="form-group row">
                        ...
                        <div class="col-xs-7 col-sm-7 col-md-7">
                            <select class="form-control" name="termo_agua" disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-7 col-sm-7 col-md-7">
                            <select class="form-control" name="termo_carboidratos" disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-7 col-sm-7 col-md-7">
                            <select class="form-control" name="termo_proteinas" disabled>
