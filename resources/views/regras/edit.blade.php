                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-xs-2 col-sm-2 col-md-2 col-form-label text-md-left">
                            <input type="checkbox" name="not_agua" value="1"
                                @if ($regra->not_agua) checked @endif>  Não</label>
                    </div>
                    <!-- Carboidratos -->
                    <div class="form-group row">
                        ...
                        <label class="col-xs-2 col-sm-2 col-md-2 col-form-label text-md-left">
                            <input type="checkbox" name="not_carboidratos" value="1"
                                @if ($regra->not_carboidratos) checked @endif>  Não</label>
                    </div>
                    <!-- Proteinas -->
                    <div class="form-group row">
                        ...
                        <label class="col-xs-2 col-sm-2 col-md-2 col-form-label text-md-left">
                            <input type="checkbox" name="not_proteinas" value="1"
                                @if ($regra->not_proteinas) checked @endif>  Não</label>
                    </div>
                    <!-- Micronutrientes -->
                    <div class="form-group row">
                        ...
                        <label class="col-xs-2 col-sm-2 col-md-2 col-form-label text-md-left">
                            <input type="checkbox" name="not_micronutrientes" value="1"
                                @if ($regra->not_micronutrientes) checked @endif>  Não</label>
                    </div>
                    </div>
                </div>
                <br/>
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-xs-2 col-sm-2 col-md-2 col-form-label text-md-left">
                            <input type="checkbox" name="not_resultado" value="1"
                                @if ($regra->not_resultado) checked @endif>  Não</label>
                    </div>
                    </div>
                </div>
                <br/>
