...
<div class="row justify-content-center">
    <div class="col-md-8">
        ...
        <form action="{{ route('producoes.update',$producao->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <input type="number" step="0.01" class="form-control" name="producao_real" autocomplete="off"
                            value="{{number_format($producao->producao_real, 2,',','')}}" required autofocus>
                    </div>
                </div>
